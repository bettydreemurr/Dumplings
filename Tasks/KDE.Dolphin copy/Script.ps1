$Prefix = 'https://cdn.kde.org/ci-builds/utilities/ark/'
...
switch -Regex ($this.Check()) {
  'New|Changed|Updated' {
    ...
    $this.CurrentState.RealVersion = Get-ItemPropertyValue -Path 'HKLM:\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Ark' -Name 'DisplayVersion'
